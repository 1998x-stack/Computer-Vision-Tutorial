...
# JSON对象
lectures = {
    "1_Course Introduction": ["Overview of computer vision"],
    "2_Image Filtering": ["Image transformations", "point image processing", "linear shift-invariant image filtering", "convolution", "image gradients"],
    "3_Image Pyramids and Frequency Domain": ["Image downsampling", "aliasing", "Gaussian image pyramid", "Laplacian image pyramid", "Fourier series", "frequency domain", "Fourier transform", "frequency-domain filtering", "sampling"],
    "4_Hough Transform": ["Finding boundaries", "line fitting", "line parameterization", "Hough transform", "Hough circles"],
    "5_Detecting Corners": ["Visualizing quadratics", "Harris corner detector", "multi-scale detection"],
    "6_Feature Detectors and Descriptors": ["Designing feature descriptors", "MOPS descriptor", "GIST descriptor", "Histogram of Textons descriptor", "HOG descriptor", "SIFT"],
    "7_2D Transformations": ["2D transformations", "projective geometry", "classification of 2D transformations", "determining unknown 2D transformations"],
    "8_Image Homographies": ["Panoramas", "Image homographies", "Computing with homographies", "direct linear transform (DLT)", "random sample consensus (RANSAC)"],
    "9_Geometric Camera Models": ["Pinhole camera", "accidental pinholes", "camera matrix"],
